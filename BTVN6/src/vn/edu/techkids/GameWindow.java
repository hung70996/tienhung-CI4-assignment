...
public class GameWindow extends Frame implements Runnable {
    ...
    BulletPresentController bulletPresentController;
    ...
    public GameWindow () {
        ...
        this.bombController = BombController.getBombController();
        this.bulletPresentController = BulletPresentController.getBulletPresentController();
...
//                }
    ...
    public void update(Graphics g) {
        ...
        bombController.paint(backbufferGraphics);
        bulletPresentController.paint(backbufferGraphics);
