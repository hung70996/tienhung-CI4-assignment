...
//        );
    ...
    public void die() {
        /* Effect */
        /* Play sound */
      //  this.gameObject = EnemyPlaneController.dieAnimation(this.gameObject.getX(), this.gameObject.getY());
...
//                        new ImageDrawer("resources/enemy_plane_white_1.png");
                ...
                gameVector = new GameVector(-2, 2);
                enemyPlaneController = new EnemyPlaneController(enemyPlane, yellowPlaneDrawer, gameVector, new EnemySpecialShotBehavior());
                break;
        }

        return enemyPlaneController;
    }
    public static EnemyPlaneController dieAnimation(int x, int y) {
        EnemyPlane enemyPlane = new EnemyPlane(x, y, EnemyPlane.WIDTH_DEFAULT, EnemyPlane.HEIGHT_DEFAULT);
        ImageDrawer imageDrawer = new ImageDrawer("resources/boom1.png");
